...
$DT_META_BOXES[] = array(
	...
	'fields' 	=> array(
		...
		array(
			...
			'type' => 'checkbox_list',
			'options' => array(
				'header' => _x('header &amp; top bar', 'backend metabox', LANGUAGE_ZONE),
				'floating_menu' => _x('floating menu', 'backend metabox', LANGUAGE_ZONE),
				'content' => _x('content area', 'backend metabox', LANGUAGE_ZONE),
		...
		array(
			'name'    		=> _x('Beautiful loading:', 'backend metabox', LANGUAGE_ZONE),
			'id'      		=> "{$prefix}page_loading",
			'type'    		=> 'radio',
			'std'			=> 'accent',
			'options'		=>array(
				'disabled' => _x( 'Disabled', 'backend metabox', LANGUAGE_ZONE ),
				'light' => _x( 'Light', 'backend metabox', LANGUAGE_ZONE ),
